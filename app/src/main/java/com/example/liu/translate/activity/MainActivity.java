...
import com.example.liu.translate.db.InviteMessage;
import com.example.liu.translate.db.InviteMessgeDao;
import com.example.liu.translate.db.UserDao;
...
//    private LayoutTitleBar titleBar;
    ...
    private void initView() {
        ...
        this.findViewById(R.id.btn_local).setOnClickListener(this);
...
//        titleBar.getTitleBarRightBtn().setImageDrawable(getResources().getDrawable(R.drawable.home_disconnected_pressed));
//        titleBar.getTitleBarRightBtn().setOnClickListener(this);
    }
...
//                startActivity(new Intent(MainActivity.this,BLEConnect2Activity.class));
